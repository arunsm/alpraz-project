function [] = printSupplementaryDataFiles3(allControlEnergies_emotionid, allControlEnergies_emotionrec)

parameters
resultsDirCurrentFigure = strcat(resultsDir, filesep, 'SupplementaryDataFiles3', filesep);
