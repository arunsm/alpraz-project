        ...
        for p = 1:numel(parcelCoverageThresh)
            ...
            for se = 1:numel(structuralEdges)
                ...
                for c = 1:numel(controlInputs)
                    ...
                    fprintf(fid, 'controlAlgorithm,normalizationMethod,avge_FD_thresh,parcelCoverageThresh,T,rho,controlInputs,structuralEdges\n%s,%s,%d,%d,%d,%d,%s,%s', controlAlgorithm, currentNormalizationMethod, current_FD_thresh, currentParcelCoverageThresh, T, rho, currentControlInputs, currentStructuralEdges);
                    fclose(fid);
