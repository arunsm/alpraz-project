...
[pValue, ~, stats] = ranksum(subjectDemographics.AgeAtFMRI(group==0), subjectDemographics.AgeAtFMRI(group==1))
...
[~, pValue, ~, stats] = ttest2(subjectDemographics.educ(group==0), subjectDemographics.educ(group==1))
...
[~, pValue, ~, stats] = ttest2(subjectDemographics.par_ed(group==0), subjectDemographics.par_ed(group==1))
...
[~, pValue, ~, stats] = ttest2(subjectDemographics.height(group==0), subjectDemographics.height(group==1))
...
[~, pValue, ~, stats] = ttest2(subjectDemographics.weight(group==0), subjectDemographics.weight(group==1))
...
[~, pValue, ~, stats] = ttest2(subjectDemographics.BMI(group==0), subjectDemographics.BMI(group==1))
...
[~, pValue, ~, stats] = ttest2(subjectDemographics.SISTOTAL(group==0), subjectDemographics.SISTOTAL(group==1))
...
[pValue, ~, stats] = ranksum(STAI_TRAIT(group==0), STAI_TRAIT(group==1))
...
[~, pValue, ~, stats] = ttest2(alpraz_levels(group==0), alpraz_levels(group==1))
end